...
require("./modules/init-swiper.js");
require("./modules/play.js");
// ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/init-swiper.js":9,"./modules/menu":10,"./modules/modals/init-modals":11,"./modules/play.js":13,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
exports.swiperTraining = exports.swiperTours = exports.swiperHero = exports.swiperGallery = exports.swiperFeedback = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var video = document.querySelector('.hero__video');
var slides = document.querySelectorAll('.hero__slide');
var audio = document.querySelector('.hero__audio');
  ...
  on: {
    slideChange: function slideChange() {
      slides.forEach(function (slide) {
        if (slide.querySelector('.hero__video') && slide.classList.contains('swiper-slide-active')) {
          // empty
        } else {
          video.pause();
        }
...
swiperHero.on('slideChangeTransitionEnd', function () {
  slides.forEach(function (slide) {
    if (slide.querySelector('.hero__audio') && slide.classList.contains('swiper-slide-active')) {
...
var swiperTours = new _swiper.default('.tours__swiper', {
  breakpoints: {
    320: {
      slidesPerView: 1,
      spaceBetween: 30
...
exports.swiperTours = swiperTours;
var swiperTraining = new _swiper.default('.training__swiper', {
  breakpoints: {
    320: {
      slidesPerView: 1,
      spaceBetween: 30
...
exports.swiperTraining = swiperTraining;
var swiperFeedback = new _swiper.default('.feedback__swiper', {
  simulateTouch: false,
  breakpoints: {
    320: {
      slidesPerView: 1
...
window.addEventListener('DOMContentLoaded', function () {
  var resizableSwiper = function resizableSwiper(breakpoint, swiperClass, swiperSettings) {
    ...
    var enableSwiper = function enableSwiper(className, settings) {
      swiper = new _swiper.default(className, settings);
    };
  ...
  resizableSwiper('(min-width: 1200px)', '.advantages__swiper', {
    loop: true,
    spaceBetween: 30,
    slidesPerView: 3,
    initialSlide: 1,
...
var video = document.querySelector('.hero__video');
var videoButton = document.querySelector('.hero__video-button');
